...
The mark-to-market shared-feed OOS candidate is versioned as `v27-oos-candidate`. It requires typed,
...
GET  /analytics/attribution?simulation_version=v27-oos-candidate
