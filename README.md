...
The mark-to-market shared-feed OOS candidate is versioned as `v28-oos-candidate`. It requires typed,
...
GET  /analytics/attribution?simulation_version=v28-oos-candidate
