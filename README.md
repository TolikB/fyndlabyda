...
The mark-to-market shared-feed OOS candidate is versioned as `v30-oos-candidate`. It requires typed,
...
GET  /analytics/attribution?simulation_version=v30-oos-candidate
