"""Read one public Hyperliquid L2 snapshot through the canonical pipeline."""
...
async def run() -> int:
    ...
    try:
        ...
        instrument = next(
            ...
            if item.exchange_symbol == "BTC" and item.instrument_type is InstrumentType.PERPETUAL
        )
