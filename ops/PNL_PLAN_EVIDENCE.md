...
| Paper-only shared-feed candidate/baseline on VM | Target release `funding-pnl-v2-20260813-067`; release 066 healthy pre-boundary | Durable overlap-audit redeploy pending |
