...
| Paper-only shared-feed candidate/baseline on VM | Release `funding-pnl-v2-20260813-066`; healthy pre-boundary postflight, restart count 0, all missing/unverifiable/mismatched/duplicate open-key counts zero | Proven running |
