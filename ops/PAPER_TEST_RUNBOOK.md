...
PAPER_AUTOTRADE_START_UTC=2026-08-14T07:30:00Z
PAPER_SIMULATION_VERSION=v30-oos-candidate
PAPER_BASELINE_SIMULATION_VERSION=v30-oos-baseline
```
...
curl 'http://127.0.0.1:8000/analytics/attribution?simulation_version=v30-oos-candidate'
...
reverse-route-deduplicated v30 canary starts with release
`funding-pnl-v2-20260814-072`. Its clean evidence boundary and enforced
autotrade boundary are both `2026-08-14T07:30:00Z`; use
...
```bash
# Earliest useful run: 2026-08-17T07:31:00Z.
...
docker compose -p funding_arbitrage_paper exec -T app \
  ...
  --start 2026-08-14T07:30:00Z \
  --gate canary \
  --timeout 45

# Earliest useful run: 2026-09-13T07:31:00Z.
cd /opt/funding_arbitrage_paper
docker compose -p funding_arbitrage_paper exec -T app \
  python scripts/paper_acceptance_audit.py \
  --start 2026-08-14T07:30:00Z \
